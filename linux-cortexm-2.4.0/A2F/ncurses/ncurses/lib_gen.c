...
{
	T((T_CALLED("addch(%s)"), _tracechtype2(0,z))); returnCode(waddch(_nc_stdscr(),(z)));
}


NCURSES_EXPORT(int) (addchnstr) (const chtype * a1, int z)
{
	T((T_CALLED("addchnstr(%p,%d)"), (const void *)a1, z)); returnCode(waddchnstr(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (addchstr) (const chtype * z)
{
	T((T_CALLED("addchstr(%p)"), (const void *)z)); returnCode(waddchnstr(_nc_stdscr(),(z),-1));
}


NCURSES_EXPORT(int) (addnstr) (const char * a1, int z)
{
	T((T_CALLED("addnstr(%s,%d)"), _nc_visbuf2(0,a1), z)); returnCode(waddnstr(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (addstr) (const char * z)
{
	T((T_CALLED("addstr(%s)"), _nc_visbuf2(0,z))); returnCode(waddnstr(_nc_stdscr(),(z),-1));
}


NCURSES_EXPORT(int) (attroff) (int z)
{
	T((T_CALLED("attroff(%s)"), _traceattr2(0,(chtype)z))); returnCode(wattr_off(_nc_stdscr(), (attr_t)((z)), ((void *)0)));
}


NCURSES_EXPORT(int) (attron) (int z)
{
	T((T_CALLED("attron(%s)"), _traceattr2(0,(chtype)z))); returnCode(wattr_on(_nc_stdscr(), (attr_t)((z)), ((void *)0)));
}


NCURSES_EXPORT(int) (attrset) (int z)
{
	T((T_CALLED("attrset(%s)"), _traceattr2(0,(chtype)z))); returnIntAttr((attr_t)((_nc_stdscr()) ? ((_nc_stdscr())->_attrs = (attr_t)((z)), (0)) : (-1)));
}


NCURSES_EXPORT(int) (attr_get) (attr_t * a1, short * a2, void * z)
{
	T((T_CALLED("attr_get(%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)z)); returnCode(((void)((((a1)) != (void *)0) ? (*((a1)) = (_nc_stdscr()) ? (_nc_stdscr())->_attrs : 0) : (0)), (void)((((a2)) != (void *)0) ? (*((a2)) = (short) ((_nc_stdscr()) ? ((int)((((unsigned long)(((_nc_stdscr())->_attrs)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8))) : 0)) : (0)), (0)));
}


NCURSES_EXPORT(int) (attr_off) (attr_t a1, void * z)
{
	T((T_CALLED("attr_off(%s,%p)"), _traceattr2(0,a1), (const void *)z)); returnCode(wattr_off(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (attr_on) (attr_t a1, void * z)
{
	T((T_CALLED("attr_on(%s,%p)"), _traceattr2(0,a1), (const void *)z)); returnCode(wattr_on(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (attr_set) (attr_t a1, short a2, void * z)
{
	T((T_CALLED("attr_set(%s,%#lx,%p)"), _traceattr2(0,a1), (long)a2, (const void *)z)); returnCode((((_nc_stdscr()) ? ((_nc_stdscr())->_attrs = ((((a1)) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) | (attr_t)((chtype)((((a2)))) << ((0) + 8)))) : (0)), (0)));
}


NCURSES_EXPORT(int) (bkgd) (chtype z)
{
	T((T_CALLED("bkgd(%s)"), _tracechtype2(0,z))); returnCode(wbkgd(_nc_stdscr(),(z)));
}


NCURSES_EXPORT(void) (bkgdset) (chtype z)
{
	T((T_CALLED("bkgdset(%s)"), _tracechtype2(0,z))); wbkgdset(_nc_stdscr(),(z));
	returnVoid;
}
...
{
	T((T_CALLED("border(%s,%s,%s,%s,%s,%s,%s,%s)"), _tracechtype2(0,a1), _tracechtype2(1,a2), _tracechtype2(2,a3), _tracechtype2(3,a4), _tracechtype2(4,a5), _tracechtype2(5,a6), _tracechtype2(6,a7), _tracechtype2(7,z))); returnCode(wborder(_nc_stdscr(), a1, a2, a3, a4, a5, a6, a7, z));
}
...
{
	T((T_CALLED("chgat(%d,%s,%#lx,%p)"), a1, _traceattr2(1,a2), (long)a3, (const void *)z)); returnCode(wchgat(_nc_stdscr(),(a1),(a2),(a3),(z)));
}


NCURSES_EXPORT(int) (clear) (void)
{
	T((T_CALLED("clear()"))); returnCode(wclear(_nc_stdscr()));
}


NCURSES_EXPORT(int) (clrtobot) (void)
{
	T((T_CALLED("clrtobot()"))); returnCode(wclrtobot(_nc_stdscr()));
}


NCURSES_EXPORT(int) (clrtoeol) (void)
{
	T((T_CALLED("clrtoeol()"))); returnCode(wclrtoeol(_nc_stdscr()));
}


NCURSES_EXPORT(int) (color_set) (short a1, void * z)
{
	T((T_CALLED("color_set(%#lx,%p)"), (long)a1, (const void *)z)); returnCode(wcolor_set(_nc_stdscr(),(a1),(z)));
}
...
{
	T((T_CALLED("delch()"))); returnCode(wdelch(_nc_stdscr()));
}


NCURSES_EXPORT(int) (deleteln) (void)
{
	T((T_CALLED("deleteln()"))); returnCode(winsdelln(_nc_stdscr(),-1));
}


NCURSES_EXPORT(int) (echochar) (const chtype z)
{
	T((T_CALLED("echochar(%s)"), _tracechtype2(0,z))); returnCode(wechochar(_nc_stdscr(),(z)));
}


NCURSES_EXPORT(int) (erase) (void)
{
	T((T_CALLED("erase()"))); returnCode(werase(_nc_stdscr()));
}
...
{
	T((T_CALLED("getch()"))); returnCode(wgetch(_nc_stdscr()));
}


NCURSES_EXPORT(int) (getnstr) (char * a1, int z)
{
	T((T_CALLED("getnstr(%s,%d)"), _nc_visbuf2(0,a1), z)); returnCode(wgetnstr(_nc_stdscr(), a1, (z)));
}


NCURSES_EXPORT(int) (getstr) (char * z)
{
	T((T_CALLED("getstr(%s)"), _nc_visbuf2(0,z))); returnCode(wgetnstr(_nc_stdscr(), (z), -1));
}


NCURSES_EXPORT(int) (hline) (chtype a1, int z)
{
	T((T_CALLED("hline(%s,%d)"), _tracechtype2(0,a1), z)); returnCode(whline(_nc_stdscr(), a1, (z)));
}


NCURSES_EXPORT(chtype) (inch) (void)
{
	T((T_CALLED("inch()"))); returnChtype(winch(_nc_stdscr()));
}


NCURSES_EXPORT(int) (inchnstr) (chtype * a1, int z)
{
	T((T_CALLED("inchnstr(%p,%d)"), (const void *)a1, z)); returnCode(winchnstr(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (inchstr) (chtype * z)
{
	T((T_CALLED("inchstr(%p)"), (const void *)z)); returnCode(winchnstr(_nc_stdscr(), (z), -1));
}
...
{
	T((T_CALLED("insch(%s)"), _tracechtype2(0,z))); returnCode(winsch(_nc_stdscr(),(z)));
}


NCURSES_EXPORT(int) (insdelln) (int z)
{
	T((T_CALLED("insdelln(%d)"), z)); returnCode(winsdelln(_nc_stdscr(),(z)));
}


NCURSES_EXPORT(int) (insertln) (void)
{
	T((T_CALLED("insertln()"))); returnCode(winsdelln(_nc_stdscr(),1));
}


NCURSES_EXPORT(int) (insnstr) (const char * a1, int z)
{
	T((T_CALLED("insnstr(%s,%d)"), _nc_visbuf2(0,a1), z)); returnCode(winsnstr(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (insstr) (const char * z)
{
	T((T_CALLED("insstr(%s)"), _nc_visbuf2(0,z))); returnCode(winsnstr(_nc_stdscr(), (z), -1));
}


NCURSES_EXPORT(int) (instr) (char * z)
{
	T((T_CALLED("instr(%s)"), _nc_visbuf2(0,z))); returnCode(winnstr(_nc_stdscr(), (z), -1));
}


NCURSES_EXPORT(int) (move) (int a1, int z)
{
	T((T_CALLED("move(%d,%d)"), a1, z)); returnCode(wmove(_nc_stdscr(),(a1),(z)));
}


NCURSES_EXPORT(int) (mvaddch) (int a1, int a2, const chtype z)
{
	T((T_CALLED("mvaddch(%d,%d,%s)"), a1, a2, _tracechtype2(2,z))); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddch((_nc_stdscr()),((z)))));
}


NCURSES_EXPORT(int) (mvaddchnstr) (int a1, int a2, const chtype * a3, int z)
{
	T((T_CALLED("mvaddchnstr(%d,%d,%p,%d)"), a1, a2, (const void *)a3, z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddchnstr((_nc_stdscr()),((a3)),((z)))));
}


NCURSES_EXPORT(int) (mvaddchstr) (int a1, int a2, const chtype * z)
{
	T((T_CALLED("mvaddchstr(%d,%d,%p)"), a1, a2, (const void *)z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddchnstr((_nc_stdscr()),((z)),-1)));
}


NCURSES_EXPORT(int) (mvaddnstr) (int a1, int a2, const char * a3, int z)
{
	T((T_CALLED("mvaddnstr(%d,%d,%s,%d)"), a1, a2, _nc_visbuf2(2,a3), z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddnstr((_nc_stdscr()),((a3)),((z)))));
}


NCURSES_EXPORT(int) (mvaddstr) (int a1, int a2, const char * z)
{
	T((T_CALLED("mvaddstr(%d,%d,%s)"), a1, a2, _nc_visbuf2(2,z))); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : waddnstr((_nc_stdscr()),((z)),-1)));
}


NCURSES_EXPORT(int) (mvchgat) (int a1, int a2, int a3, attr_t a4, short a5, const void * z)
{
	T((T_CALLED("mvchgat(%d,%d,%d,%s,%#lx,%p)"), a1, a2, a3, _traceattr2(3,a4), (long)a5, (const void *)z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wchgat((_nc_stdscr()),((a3)),((a4)),((a5)),((z)))));
}


NCURSES_EXPORT(int) (mvdelch) (int a1, int z)
{
	T((T_CALLED("mvdelch(%d,%d)"), a1, z)); returnCode((wmove((_nc_stdscr()),((a1)),((z))) == (-1) ? (-1) : wdelch(_nc_stdscr())));
}


NCURSES_EXPORT(int) (mvgetch) (int a1, int z)
{
	T((T_CALLED("mvgetch(%d,%d)"), a1, z)); returnCode((wmove((_nc_stdscr()),((a1)),((z))) == (-1) ? (-1) : wgetch(_nc_stdscr())));
}


NCURSES_EXPORT(int) (mvgetnstr) (int a1, int a2, char * a3, int z)
{
	T((T_CALLED("mvgetnstr(%d,%d,%s,%d)"), a1, a2, _nc_visbuf2(2,a3), z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wgetnstr((_nc_stdscr()),((a3)),((z)))));
}


NCURSES_EXPORT(int) (mvgetstr) (int a1, int a2, char * z)
{
	T((T_CALLED("mvgetstr(%d,%d,%s)"), a1, a2, _nc_visbuf2(2,z))); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wgetnstr((_nc_stdscr()), ((z)), -1)));
}


NCURSES_EXPORT(int) (mvhline) (int a1, int a2, chtype a3, int z)
{
	T((T_CALLED("mvhline(%d,%d,%s,%d)"), a1, a2, _tracechtype2(2,a3), z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : whline((_nc_stdscr()),((a3)),((z)))));
}


NCURSES_EXPORT(chtype) (mvinch) (int a1, int z)
{
	T((T_CALLED("mvinch(%d,%d)"), a1, z)); returnChtype((wmove((_nc_stdscr()),((a1)),((z))) == (-1) ? (chtype)((-1)) : winch(_nc_stdscr())));
}


NCURSES_EXPORT(int) (mvinchnstr) (int a1, int a2, chtype * a3, int z)
{
	T((T_CALLED("mvinchnstr(%d,%d,%p,%d)"), a1, a2, (const void *)a3, z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winchnstr((_nc_stdscr()),((a3)),((z)))));
}


NCURSES_EXPORT(int) (mvinchstr) (int a1, int a2, chtype * z)
{
	T((T_CALLED("mvinchstr(%d,%d,%p)"), a1, a2, (const void *)z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winchnstr((_nc_stdscr()), ((z)), -1)));
}
...
{
	T((T_CALLED("mvinsch(%d,%d,%s)"), a1, a2, _tracechtype2(2,z))); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winsch((_nc_stdscr()),((z)))));
}


NCURSES_EXPORT(int) (mvinsnstr) (int a1, int a2, const char * a3, int z)
{
	T((T_CALLED("mvinsnstr(%d,%d,%s,%d)"), a1, a2, _nc_visbuf2(2,a3), z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winsnstr((_nc_stdscr()),((a3)),((z)))));
}


NCURSES_EXPORT(int) (mvinsstr) (int a1, int a2, const char * z)
{
	T((T_CALLED("mvinsstr(%d,%d,%s)"), a1, a2, _nc_visbuf2(2,z))); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winsnstr((_nc_stdscr()), ((z)), -1)));
}


NCURSES_EXPORT(int) (mvinstr) (int a1, int a2, char * z)
{
	T((T_CALLED("mvinstr(%d,%d,%s)"), a1, a2, _nc_visbuf2(2,z))); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : winnstr((_nc_stdscr()), ((z)), -1)));
}


NCURSES_EXPORT(int) (mvvline) (int a1, int a2, chtype a3, int z)
{
	T((T_CALLED("mvvline(%d,%d,%s,%d)"), a1, a2, _tracechtype2(2,a3), z)); returnCode((wmove((_nc_stdscr()),((a1)),((a2))) == (-1) ? (-1) : wvline((_nc_stdscr()),((a3)),((z)))));
}
...
{
	T((T_CALLED("refresh()"))); returnCode(wrefresh(_nc_stdscr()));
}


NCURSES_EXPORT(int) (scrl) (int z)
{
	T((T_CALLED("scrl(%d)"), z)); returnCode(wscrl(_nc_stdscr(),(z)));
}
...
{
	T((T_CALLED("setscrreg(%d,%d)"), a1, z)); returnCode(wsetscrreg(_nc_stdscr(),(a1),(z)));
}
...
{
	T((T_CALLED("standout()"))); returnIntAttr((attr_t)(((_nc_stdscr()) ? ((_nc_stdscr())->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0)) : (-1))));
}


NCURSES_EXPORT(int) (standend) (void)
{
	T((T_CALLED("standend()"))); returnIntAttr((attr_t)(((_nc_stdscr()) ? ((_nc_stdscr())->_attrs = (attr_t)((1U - 1U)), (0)) : (-1))));
}


NCURSES_EXPORT(void) (timeout) (int z)
{
	T((T_CALLED("timeout(%d)"), z)); wtimeout(_nc_stdscr(),(z));
	returnVoid;
}
...
{
	T((T_CALLED("vline(%s,%d)"), _tracechtype2(0,a1), z)); returnCode(wvline(_nc_stdscr(), a1, (z)));
}
...
{
	T((T_CALLED("mouse_trafo(%p,%p,%#lx)"), (const void *)a1, (const void *)a2, (long)z)); returnBool(wmouse_trafo(_nc_stdscr(),a1,a2,z));
}
