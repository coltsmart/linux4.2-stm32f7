...
(*.[0-9]*)
	...
	if test ! -f /work/psl/SF/release/linux-cortexm-2.4.0/A2F/ncurses/man_alias.sed ; then
cat >>/work/psl/SF/release/linux-cortexm-2.4.0/A2F/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /work/psl/SF/release/linux-cortexm-2.4.0/A2F/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /work/psl/SF/release/linux-cortexm-2.4.0/A2F/ncurses/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /work/psl/SF/release/linux-cortexm-2.4.0/A2F/ncurses/man_alias.sed \
		< $i >$TMP
